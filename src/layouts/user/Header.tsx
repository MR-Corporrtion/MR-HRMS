...
const Header = () => {
  ...
  return (
    <header>
      <section className="main-container h-20 flex items-center justify-end p-4 bg-gradient-to-r from-[#ee7623] to-white shadow-md transition duration-500 ease-in-out">
        ...
        <div className="mx-8 flex gap-6 items-center">
          <img src={logo_pic.src} alt="Company Logo" className="h-20 w-auto" />
